<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='jingli'"  label='部门经理编号' prop="jingliUuidNumber">
               <el-input v-model="ruleForm.jingliUuidNumber"disabled="true"   placeholder='部门经理编号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='jingli'"  label='部门经理姓名' prop="jingliName">
               <el-input v-model="ruleForm.jingliName"  placeholder='部门经理姓名' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='jingli'"  label='部门经理手机号' prop="jingliPhone">
               <el-input v-model="ruleForm.jingliPhone"  placeholder='部门经理手机号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='jingli'"  label='部门经理身份证号' prop="jingliIdNumber">
               <el-input v-model="ruleForm.jingliIdNumber"  placeholder='部门经理身份证号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='jingli'" label='部门经理头像' prop="jingliPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='jingli'"  label='部门经理邮箱' prop="jingliEmail">
               <el-input v-model="ruleForm.jingliEmail"  placeholder='部门经理邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
...
|| flag=='jingli')"  label="性别" prop="sexTypes">
