    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">企业内管信息化系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="部门经理编号" class="input" v-if="tableName=='jingli'">
                                <el-input v-model="ruleForm.jingliUuidNumber" autocomplete="off" placeholder="部门经理编号"  />
                           </el-form-item>
                        -->
                        <el-form-item label="部门经理姓名" class="input" v-if="tableName=='jingli'">
                            <el-input v-model="ruleForm.jingliName" autocomplete="off" placeholder="部门经理姓名"  />
                        </el-form-item>
                        <el-form-item label="部门经理手机号" class="input" v-if="tableName=='jingli'">
                            <el-input v-model="ruleForm.jingliPhone" autocomplete="off" placeholder="部门经理手机号"  />
                        </el-form-item>
                        <el-form-item label="部门经理身份证号" class="input" v-if="tableName=='jingli'">
                            <el-input v-model="ruleForm.jingliIdNumber" autocomplete="off" placeholder="部门经理身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="jingliPhotoFlag">
                            </el-form-item>
                            <el-form-item label="部门经理头像" class="input" v-if="tableName=='jingli'">
                                    <file-upload
                                        tip="点击上传部门经理头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="部门经理邮箱" class="input" v-if="tableName=='jingli'">
                            <el-input v-model="ruleForm.jingliEmail" autocomplete="off" placeholder="部门经理邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='jingli'">
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                jingliPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            jingliPhotoUploadChange(fileUrls) {
               this.ruleForm.jingliPhoto = fileUrls;
                if(this.jingliPhotoFlag){
                    this.jingliPhotoFlag=false;
                }else{
                    this.jingliPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            // jingli 中的 部门经理编号 判空处理
                            // if('jingli' == this.tableName && (this.ruleForm.jingliUuidNumber== null ||this.ruleForm.jingliUuidNumber== "")){
                            //     this.$message.error("部门经理编号不能为空");
                            //     return
                            // }
                            if((!this.ruleForm.jingliName)&& 'jingli'==this.tableName){
                                this.$message.error('部门经理姓名不能为空');
                                return
                            }
                             if('jingli' == this.tableName && this.ruleForm.jingliPhone&&(!this.$validate.isMobile(this.ruleForm.jingliPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.jingliIdNumber)&& 'jingli'==this.tableName){
                                this.$message.error('部门经理身份证号不能为空');
                                return
                            }
                            // jingli 中的 部门经理头像 判空处理
                            // if('jingli' == this.tableName && (this.ruleForm.jingliPhoto== null ||this.ruleForm.jingliPhoto== "")){
                            //     this.$message.error("部门经理头像不能为空");
                            //     return
                            // }
                            if('jingli' == this.tableName && this.ruleForm.jingliEmail&&(!this.$validate.isEmail(this.ruleForm.jingliEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // jingli 中的 创建时间 判空处理
                            // if('jingli' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/qiyeneixinxihauxitong/img/back-img-bg.jpg);
