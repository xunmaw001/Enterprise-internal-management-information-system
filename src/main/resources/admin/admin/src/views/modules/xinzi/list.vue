        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.xinziName" placeholder="标题" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/qiyeneixinxihauxitong/upload/xinziMuBan.xls"
                        >批量导入薪资数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xinzi','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="jiangjinFangtie"
                                   header-align="center"
                                   label="房帖">
                        <template slot-scope="scope">
                            {{scope.row.jiangjinFangtie}}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="jixiaoGongjijin"
                                   header-align="center"
                                   label="扣公积金">
                        <template slot-scope="scope">
                            {{scope.row.jixiaoGongjijin}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                ...
                jibenJine : null,
                jiangjinJine : null,
                jiangjinFangtie : null,
                jiangjinJijin : null,
                jixiaoJine : null,
                jixiaoGongjijin : null,
                jixiaoYibao : null,
                jixiaoYanglao : null,
                jixiaoShibao : null,
                jixiaoKoushui : null,
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.xinziName!= '' && this.searchForm.xinziName!= undefined) {
                    params['xinziName'] = '%' + this.searchForm.xinziName + '%'
                }
