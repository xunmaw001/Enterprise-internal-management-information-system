...
public class XinziController {
    ...
    */
    ...
    public R save(@RequestBody XinziEntity xinzi, HttpServletRequest request){
        ...
        if(xinziEntity==null){
            double koukuan = xinzi.getJixiaoGongjijin() + xinzi.getJixiaoYibao() + xinzi.getJixiaoYanglao() + xinzi.getJixiaoKoushui() + xinzi.getJixiaoShibao() + xinzi.getJixiaoShijia() + xinzi.getJixiaoBingjia();
            double yingfa = xinzi.getJiangjinJine() + xinzi.getJibenJine() + xinzi.getJiangjinFangtie() + xinzi.getJixiaoJine();
            xinzi.setXiaojiYingkou(koukuan);
            xinzi.setXiaojiYingfa(yingfa);
            xinzi.setInsertTime(new Date());
            xinzi.setCreateTime(new Date());
            xinzi.setShifaJine(yingfa-koukuan);//薪资表特有,不需要可以手动删掉
...
//                            xinziEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
...
//                            xinziEntity.setJibenJine(data.get(0));                    //岗位工资 要改的
//                            xinziEntity.setJiangjinJine(data.get(0));                    //薪级工资 要改的
//                            xinziEntity.setJiangjinFangtie(data.get(0));                    //房帖 要改的
//                            xinziEntity.setJiangjinJijin(data.get(0));                    //公积金 要改的
//                            xinziEntity.setJixiaoJine(data.get(0));                    //业绩津贴 要改的
//                            xinziEntity.setJixiaoGongjijin(data.get(0));                    //扣公积金 要改的
//                            xinziEntity.setJixiaoYibao(data.get(0));                    //扣医保 要改的
//                            xinziEntity.setJixiaoYanglao(data.get(0));                    //扣养老保险 要改的
//                            xinziEntity.setJixiaoShibao(data.get(0));                    //扣失保金 要改的
//                            xinziEntity.setJixiaoKoushui(data.get(0));                    //扣税款 要改的
//                            xinziEntity.setJixiaoShijia(data.get(0));                    //事假扣款 要改的
//                            xinziEntity.setJixiaoBingjia(data.get(0));                    //病假扣款 要改的
//                            xinziEntity.setXiaojiYingkou(data.get(0));                    //应扣小计 要改的
//                            xinziEntity.setXiaojiYingfa(data.get(0));                    //应发小计 要改的
